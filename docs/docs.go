    ...
    "paths": {
        ...
        "/readers/": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.ReaderResponseDTO"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reader to create",
                        "name": "reader",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReaderCreateDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/readers/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated reader data",
                        "name": "reader",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReaderUpdateDTO"
                        }
                    }
                ],
                "responses": {
